...
import { HeaderLogo, MenuIcon } from './CustomIcons'
...
useEffect(() => {
  ...
  return (
    <Box position={'sticky'} top={0} width={'100vw'} zIndex={1000}>
      <Flex
        ...
        <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }} >
          <HeaderLogo show={false} isDark={false}
          />
        </Flex>
        <Stack
          flex={{ base: 1, md: 0 }}
    ...
    {
        isOpen && <MenuDrawer isOpen={isOpen} onClose={onToggle}/>
    }
       
      {/* <Collapse in={isOpen} animateOpacity>last
      </Collapse> */}
    </Box>
  )
}
